const DB = require('../db');
module.exports = {
  getToDosByUserId: userId => DB.q('SELECT TODOID AS todoId, USERID AS userId, TODODESC AS todoDesc, Time as time, STATUS AS status FROM USERTODOS WHERE USERID = ?', [userId]),
